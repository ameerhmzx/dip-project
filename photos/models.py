...
from photos.elastic_search import set_person
...
class StateAwareModel(models.Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        post_save.connect(
            ...
            dispatch_uid='{name}-StateAwareModelSweeper'.format(
    ...
    def get_dirty_fields(self):
        if self._state.adding:
            ...
            return {
                k: {'current': v}
                for k, v in self.as_dict(include_primary_key=pk_specified).items()
            }
